...
$link="https:\\emhealth.000webhostapp.com\trainset.csv";
$svm = new Java("svm_train");
$pred=new Java("svm_predict");
$model=$svm->svm_train($link);
...
$test=array($ft1,$ft2,$ft3,$ft4,$ft5);
$result=$pred->svm_predict($model,$test);
